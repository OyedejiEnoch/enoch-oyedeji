...
const SingleProjectClient = ({ project }: { project: Project }) => {
          ...
          <div ref={textRef} className='w-full md:w-1/2'>
            ...
            <div className='text-[17px] text-neutral-500 dark:text-neutral-400 mt-4 leading-7'>
              ...
              <div className='mt-4 text-white flex flex-col'>
                ...
                <div className='flex items-center gap-x-6 flex-wrap'>
                  {project.frameworks.map((framework) => (
                    <span key={framework.id} className='mt-2 text-sm'>
                      {framework.name}
                    </span>
                  ))}
                </div>
              ...
              <div className='flex items-center justify-between mt-6'>
                <button className='bg-neutral-500/30 text-white px-4 py-2 rounded-xl flex items-center gap-1 cursor-pointer hover:bg-white transition duration-300 hover:text-black'>
                  <Github /> View Code
                </button>
                <button className='bg-neutral-500/30 text-white px-4 py-2 rounded-xl flex items-center gap-1 cursor-pointer hover:bg-white transition duration-300 hover:text-black'>
